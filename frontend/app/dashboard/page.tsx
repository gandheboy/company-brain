...
export default function Dashboard() {
  ...
  const handleConnectSlack = async () => {
    try {
      const result = await apiGet('/api/integrations/slack/connect')
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Your Company Brain is ready. Connect your first integration to
